  ...
  return (
    ...
    className='pb-16 text-center'>
      ...
      <motion.button 
        ...
        className='inline-flex items-center gap-3 px-12 py-4 rounded-full bg-gradient-to-r from-purple-600 via-pink-500 to-blue-600 text-white m-auto cursor-pointer shadow-xl hover:shadow-2xl'
      ...
      >
        <span className="font-semibold">Launch ArtifyAI</span>
